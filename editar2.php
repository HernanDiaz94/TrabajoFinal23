...
$error = false;
    ...
    if ($_GET['id']) {
        $conexion1 = new Mongo();
        $resultado = $conexion1->find($_GET['id'], 'problemas');
    ...
    if (!$error) {
        ?>
            ...
            <form action="grabar_problemas.php" method="POST" enctype="multipart/form-data">
                ...
                <label class='control-label' for="fecha">Fecha</label><br>
                <input class='form-control' type="text" name="fecha" id="fecha" value="<?=$fecha?>"><br>
                
                <label class='control-label' for="area">Area</label><br>
                <input class='form-control' type="text" name="area" id="area" value="<?=$area?>"><br><br>
                
                <label class='control-label' for="tipo">Tipo de Problema</label><br>
                <input class='form-control' type="text" name="tipo" id="tipo" value="<?=$tipo?>"><br><br>
                <label class='control-label' for="precio">Resumen</label><br>
                <input class='form-control' type="text" name="resumen" id="resumen" value="<?=$resumen?>"><br><br>
                <select class='form-control' name="estado" id="estado" value="<?=$estado?>" required>
