...
$error = false;
    ...
    if (!$error) {
        ?>
            ...
            <form action="grabar_perfil.php" method="POST" enctype="multipart/form-data">
                <input type="hidden" name="id" value="<?=$id?>" required>
               
                <label required class='control-label' for="nombre_y_apellido">Nombre y Apellido</label><br>
                ...
                <input required class='form-control' type="text" name="DNI" id="DNI" value="<?=$DNI?>"><br><br>
                ...
                <label class='control-label' for="usuario">Usuario</label><br>
                ...
                <option value="Prefiero no Especificar" <?=$sexo == 'Prefiero no Especificar' ? 'selected' : ''?> >Prefiero no Especificar</option>
                </select> <br>
