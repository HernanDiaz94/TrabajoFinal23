  ...
  <div id='wrapper'>
    ...
    <section id='tools'>
      <ul class='breadcrumb' id='breadcrumb'>
        <li class='title'>INSERTAR INSUMOS</li>
    ...
    <div id='content'>
      ...
      <input required  class='form-control' name="nombre_insumo" type="text" placeholder="Ingrese el Insumo">
      ...
      <input required  class='form-control' name="tipo_insumo" type="text" placeholder="Ingrese el Insumo">
